...
const createOrderUseCase = new CreateOrderUseCase(ingredientsRepository, snacksRepository, orderRepository);
const createOrderController = new CreateOrderController(createOrderUseCase);

export const createOrderHandler = new CreateOrderHandler(createOrderController).lambdaHandler;
